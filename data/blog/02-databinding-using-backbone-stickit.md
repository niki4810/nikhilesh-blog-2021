...
summary: "In my previous post we looked at setting up data-bindings between our backbone views and models using the Backbone.Modelbinder plugin"
date: '2013-05-04 10:56'
tags: ["Backbone", "Backbone-Stickit", "Data-Binding"]
---

In my previous [post](http://niki4810.github.io/blog/2013/03/02/new-post/) we looked at setting up data-bindings between our backbone views and models using the `Backbone.Modelbinder` plugin. In this post, I will demonstrate another viable alternative for data-binding called `Backbone.Stickit`. 
